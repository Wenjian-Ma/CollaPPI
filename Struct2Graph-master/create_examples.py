...
def dataset_construction(path):
    ...
    os.chdir('/media/ST-18T/Ma/Struct2Graph-master')
...
#
# print('Total number of examples : ' + str(len(merge_examples)))
merge_examples_train = dataset_construction('train_cmap.actions.tsv')
merge_examples_test = dataset_construction('test_cmap.actions.tsv')
...
np.save('train_examples',merge_examples_train)
np.save('one_to_one_test_examples',merge_examples_test)
