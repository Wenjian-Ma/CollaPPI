...
data_list = []
for i in os.listdir('/media/ST-18T/Ma/MV-PPI/data/yeast/dictionary/pdb'):
    data_list.append(i.split('.')[0]+'\t'+i.split('.')[0]+'\t'+'A')
...
filepath = "/media/ST-18T/Ma/MV-PPI/data/yeast/dictionary/pdb/"
os.chdir(filepath)

dir_input = ('input' + str(radius) + '/')

store_dir = '/media/ST-18T/Ma/Struct2Graph-master/pdb_files/input1/'
    ...
    if not is_empty_pdb(pdb_ids[n]):
        ...
        try:
            ...
            if count % 10 == 0 or n == num_prots - 1:
                ...
                np.save(store_dir + 'proteins_' + str(10 * q_count + 1) + '_' + str(10 * (q_count + 1)), proteins)
                np.save(store_dir + 'adjacencies_' + str(10 * q_count + 1) + '_' + str(10 * (q_count + 1)), adjacencies)
                np.save(store_dir + 'names_' + str(10 * q_count + 1) + '_' + str(10 * (q_count + 1)), pnames)
                np.save(store_dir + 'seqs_' + str(10 * q_count + 1) + '_' + str(10 * (q_count + 1)), pseqs)
...
dump_dictionary(fingerprint_dict, store_dir + 'fingerprint_dict.pickle')
